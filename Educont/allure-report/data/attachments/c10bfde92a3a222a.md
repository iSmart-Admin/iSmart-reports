      ...
      - generic [ref=e96]:
        - region "Задача для решения" [ref=e98] [cursor=pointer]:
          - generic [ref=e101]:
            ...
            - generic [ref=e113]:
              - img "decore" [ref=e116]
              - generic [ref=e122]: Какое предложение содержит верную информацию о политических партиях?
            - generic [ref=e125]:
              - generic [ref=e130] [cursor=pointer]: Все политические партии имеют одного или нескольких лидеров.
              - generic [ref=e135] [cursor=pointer]: "По идеологическому признаку выделяют такие типы партий: либеральные, кадровые, консервативные, социал-демократические и массовые."
