      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "Найди предложение, в котором использован фразеологизм." [level=4] [ref=e107]:
                - generic [ref=e109]: Найди предложение, в котором использован фразеологизм.
            - img "decore" [ref=e114]
            - generic [ref=e117]:
              - button "Пришла пора взять быка за рога." [ref=e119] [cursor=pointer]:
                - generic [ref=e121] [cursor=pointer]: Пришла пора взять быка за рога.
              - button "Быки используют рога в сражениях друг с другом." [ref=e123] [cursor=pointer]:
                - generic [ref=e125] [cursor=pointer]: Быки используют рога в сражениях друг с другом.
              - button "Пастух привязал быка за рога." [ref=e127] [cursor=pointer]:
                - generic [ref=e129] [cursor=pointer]: Пастух привязал быка за рога.
