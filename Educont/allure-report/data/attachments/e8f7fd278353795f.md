      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            ...
            - generic [ref=e111]:
              - img "decore" [ref=e114]
              - generic [ref=e120]: Мутационная изменчивость, в отличие от модификационной характеризуется?
            - generic [ref=e123]:
              - generic [ref=e127] [cursor=pointer]: Носит обратимый характер
              - generic [ref=e131] [cursor=pointer]: Передаётся по наследству
              - generic [ref=e135] [cursor=pointer]: Характерна для всех особей вида
              - generic [ref=e139] [cursor=pointer]: Является проявлением нормы реакции признака
