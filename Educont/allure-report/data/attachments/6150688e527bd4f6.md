      ...
      - generic [ref=e90]:
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - generic [ref=e107]:
              - img "decore" [ref=e110]
              - generic [ref=e116]: Соотнеси эпизоды из произведения и названия элементов сюжета.
            - generic [ref=e118]:
              - generic [ref=e119]:
                - generic [ref=e120]:
                  - generic [ref=e126]: Ваня отправился на задание вместе с разведчиками, его схватили фашисты и устроили допрос.
                  - button [disabled] [ref=e132]
                - generic [ref=e133]:
                  - generic [ref=e139]: разведчики случайно нашли Ваню в лесу, мальчик попал в полк, где солдаты с удовольствием взяли над ним шефство.
                  - button [disabled] [ref=e145]
                - generic [ref=e146]:
                  - generic [ref=e152]: Енакиев специально отправил мальчика с донесением в штаб дивизии, тем самым спас его от гибели.
                  - button [disabled] [ref=e158]
              - generic [ref=e159]:
                - button "завязка" [ref=e163] [cursor=pointer]:
                  - generic [ref=e164] [cursor=pointer]: завязка
                - button "кульминация" [ref=e168] [cursor=pointer]:
                  - generic [ref=e169] [cursor=pointer]: кульминация
                - button "развязка" [ref=e173] [cursor=pointer]:
                  - generic [ref=e174] [cursor=pointer]: развязка
