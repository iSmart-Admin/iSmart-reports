        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Глаголы переходные и непереходные" [ref=e32] [cursor=pointer]':
      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            - generic [ref=e100]:
              - img [ref=e104]
              - heading "Распредели глаголы в два столбика." [level=4] [ref=e106]:
                - generic [ref=e108]: Распредели глаголы в два столбика.
            - img "decore" [ref=e113]
            - generic [ref=e115]:
              - generic [ref=e116]:
                - generic [ref=e120]: переходные
                - generic [ref=e127]: непереходные
              - generic [ref=e131]:
                - button "гордится сестрой" [ref=e135] [cursor=pointer]:
                  - generic [ref=e137] [cursor=pointer]: гордится сестрой
                - button "плывут по морю" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: плывут по морю
                - button "подарил дедушке" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: подарил дедушке
                - button "заметил нору" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: заметил нору
                - button "встретил товарища" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: встретил товарища
                - button "собирают ромашки" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: собирают ромашки
