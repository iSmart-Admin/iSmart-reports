      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Соотнеси название заболевания и возможные способы заражения.
            - generic [ref=e128]:
              - img [ref=e129]
              - generic [ref=e130]:
                - generic [ref=e136] [cursor=pointer]: Находятся на дверных ручках и других бытовых предметах, переносчики мухи и тараканы.
                - generic [ref=e143] [cursor=pointer]: Ботулизм
              - generic [ref=e144]:
                - generic [ref=e150] [cursor=pointer]: Живут в почве, заражаются ими через грязные руки, немытые фрукты и овощи.
                - generic [ref=e157] [cursor=pointer]: Сальмонеллёз
              - generic [ref=e158]:
                - generic [ref=e164] [cursor=pointer]: Обитает на продуктах — яйцах, молоке, мясе.
                - generic [ref=e171] [cursor=pointer]: Глисты или гельминты
              - generic [ref=e172]:
                - generic [ref=e178] [cursor=pointer]: Живут в почве и попадают в организм человека с овощами, грибами.
                - generic [ref=e185] [cursor=pointer]: Дизентерия
        - button "1 Взять 1 подсказку" [ref=e194] [cursor=pointer]:
