      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Укажи верные утверждения о причинах отсталости сельского хозяйства Франции при Cтаром порядке.
            - generic [ref=e128]:
              - button "Крестьянское малоземелье" [ref=e130] [cursor=pointer]:
                - generic [ref=e132] [cursor=pointer]: Крестьянское малоземелье
              - button "Чересполосица" [ref=e134] [cursor=pointer]:
                - generic [ref=e136] [cursor=pointer]: Чересполосица
              - button "Неразвитость передовых технологий обработки земли" [ref=e138] [cursor=pointer]:
                - generic [ref=e140] [cursor=pointer]: Неразвитость передовых технологий обработки земли
              - button "Быстрый рост капиталистических отношений" [ref=e142] [cursor=pointer]:
                - generic [ref=e144] [cursor=pointer]: Быстрый рост капиталистических отношений
