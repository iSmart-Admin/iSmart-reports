      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Как контролируют невырождение чистых линий растений?
            - generic [ref=e128]:
              - generic [ref=e132] [cursor=pointer]: Держат растения по одному в пространстве.
              - generic [ref=e136] [cursor=pointer]: Принудительный запрет на перекрёстное опыление.
              - generic [ref=e140] [cursor=pointer]: Делают нефертильные растения.
