        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Самостоятельные и служебные части речи" [ref=e32] [cursor=pointer]':
      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            - generic [ref=e100]:
              - img [ref=e104]
              - heading "В какой строке перечислены только служебные части речи?" [level=4] [ref=e106]:
                - generic [ref=e108]:
                  - text: В какой строке перечислены только
                  - strong [ref=e109]: служебные
                  - text: части речи?
            - img "decore" [ref=e114]
            - generic [ref=e117]:
              - button "верность, ярко, ты" [ref=e119] [cursor=pointer]:
                - generic [ref=e121] [cursor=pointer]: верность, ярко, ты
              - button "одиннадцать, выше, крепость" [ref=e123] [cursor=pointer]:
                - generic [ref=e125] [cursor=pointer]: одиннадцать, выше, крепость
              - button "над, про, но" [ref=e127] [cursor=pointer]:
                - generic [ref=e129] [cursor=pointer]: над, про, но
              - button "заря, родина, лесной" [ref=e131] [cursor=pointer]:
                - generic [ref=e133] [cursor=pointer]: заря, родина, лесной
