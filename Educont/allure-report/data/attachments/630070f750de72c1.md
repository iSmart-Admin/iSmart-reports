      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "Выберите верный вариант ответа." [level=4] [ref=e107]:
                - generic [ref=e109]: Выберите верный вариант ответа.
            - generic [ref=e111]:
              - img "decore" [ref=e114]
              - generic [ref=e120]: Кем впервые официально был использован термин «холодная война» для обозначения советско-американских отношений?
            - generic [ref=e123]:
              - button "Уинстон Черчилль" [ref=e125] [cursor=pointer]:
                - generic [ref=e127] [cursor=pointer]: Уинстон Черчилль
              - button "Гарри Трумэн" [ref=e129] [cursor=pointer]:
                - generic [ref=e131] [cursor=pointer]: Гарри Трумэн
              - button "Бернард Барух" [ref=e133] [cursor=pointer]:
                - generic [ref=e135] [cursor=pointer]: Бернард Барух
              - button "Никита Хрущев" [ref=e137] [cursor=pointer]:
                - generic [ref=e139] [cursor=pointer]: Никита Хрущев
