      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            ...
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Соотнеси типы мышечных волокон с их признаками.
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: Красные мышечные волокна
                - generic [ref=e133]: Белые мышечные волокна
              - generic [ref=e137]:
                - button "Медленное сокращение и расслабление" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: Медленное сокращение и расслабление
                - button "Поддержание позы" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Поддержание позы
                - button "Быстрое утомление" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Быстрое утомление
                - button "Быстрое сокращение и расслабление" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: Быстрое сокращение и расслабление
                - button "Большой запас гликогена" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Большой запас гликогена
                - button "Глубокие мышцы конечностей" [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: Глубокие мышцы конечностей
