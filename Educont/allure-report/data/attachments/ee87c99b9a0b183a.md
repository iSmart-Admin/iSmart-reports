      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Выбери и укажи строку, в которой записано сложносочинённое предложение." [level=4] [ref=e112]:
                - generic [ref=e114]: Выбери и укажи строку, в которой записано сложносочинённое предложение.
            - img "decore" [ref=e119]
            - generic [ref=e122]:
              - generic [ref=e124] [cursor=pointer]:
                - generic [ref=e128] [cursor=pointer]: Солнце ещё не всходило, но небо заметно посветлело, предвещая своим серым, однообразным тоном начало ненастного дня.
                - emphasis [ref=e133] [cursor=pointer]: (А.И. Куприн)
              - generic [ref=e135] [cursor=pointer]:
                - generic [ref=e139] [cursor=pointer]: Заколдован невидимкой, дремлет лес под сказку сна.
                - emphasis [ref=e144] [cursor=pointer]: (С.А. Есенин)
              - generic [ref=e146] [cursor=pointer]:
                - generic [ref=e150] [cursor=pointer]: Ружьё, собака, лошадь — всё было предметом мены…
                - emphasis [ref=e155] [cursor=pointer]: (Н.В. Гоголь)
