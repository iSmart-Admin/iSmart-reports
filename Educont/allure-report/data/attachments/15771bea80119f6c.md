      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Выберите верный вариант ответа в выпадающем списке." [level=4] [ref=e112]:
                - generic [ref=e114]: Выберите верный вариант ответа в выпадающем списке.
            - img "decore" [ref=e119]
            - generic [ref=e124]:
              - text: Развитие под влиянием США интеграционных процессов в странах Западной Европы и Северной Америки породило новое явление —
              - button [ref=e126] [cursor=pointer]
              - text: . Она характеризуется активным развитием финансовых, торговых и промышленных межгосударственных связей, формированием всеобщего информационного пространства на базе компьютеризации. Углублялся разрыв между экономически развитыми и «отстающими» странами, в число которых попадал СССР, поскольку постиндустриальный переход в нем происходил гораздо медленнее.
