      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "Отметь второстепенные члены, к которым вопрос задаётся от сказуемого." [level=4] [ref=e107]:
                - generic [ref=e109]: Отметь второстепенные члены, к которым вопрос задаётся от сказуемого.
            - generic [ref=e111]:
              - img "decore" [ref=e114]
              - generic [ref=e119]:
                - generic [ref=e120]: Это одиночество меня нисколько не стесняет.
                - emphasis [ref=e122]: (по М. М. Пришвину)
            - generic [ref=e126]:
              - generic [ref=e129] [cursor=pointer]: это
              - generic [ref=e132] [cursor=pointer]: одиночество
              - generic [ref=e135] [cursor=pointer]: меня
              - generic [ref=e138] [cursor=pointer]: нисколько
              - generic [ref=e141] [cursor=pointer]: не
