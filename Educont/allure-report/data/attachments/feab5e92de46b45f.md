        ...
        - region "Задача для решения" [ref=e25] [cursor=pointer]:
          - generic [ref=e26] [cursor=pointer]:
            ...
            - generic [ref=e35]:
              ...
              - generic [ref=e47]:
                - img "decore" [ref=e50]
                - generic [ref=e56]: Выберите аргумент в пользу того, что эволюция необратима.
              - generic [ref=e61]:
                - generic [ref=e63] [cursor=pointer]: Организмам не выгодно возвращаться к исходным признакам.
                - generic [ref=e65] [cursor=pointer]: Популяция не возвращается в свое местообитание — поэтому на них не действуют те же факторы отбора.
                - generic [ref=e67] [cursor=pointer]: В процессе эволюции меняются гены (в том числе утрачиваются старые или приобретаются новые), поэтому вернуть их в исходное состояние невозможно.
        - generic [ref=e72]:
          - generic [ref=e75]:
      ...
      - generic [ref=e99]:
        ...
        - generic [ref=e119]:
          ...
          - generic [ref=e143]:
            ...
            - generic [ref=e150]: 69c9bb29464c1d0007568f25
```