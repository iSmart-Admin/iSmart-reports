      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Какое из утверждений наиболее точно определяет тему стихотворения «Пророк»?
            - generic [ref=e116]:
              - generic [ref=e120] [cursor=pointer]: авторская исповедь
              - generic [ref=e124] [cursor=pointer]: результат религиозно-мистических переживаний
              - generic [ref=e128] [cursor=pointer]: философская проблема предназначения поэта и поэтического творчества
