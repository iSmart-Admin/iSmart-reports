      ...
      - generic [ref=e96]:
        - region "Задача для решения" [ref=e98] [cursor=pointer]:
          - generic [ref=e101]:
            ...
            - generic [ref=e113]:
              - img "decore" [ref=e116]
              - generic [ref=e122]: Выбери верные и неверные утверждение о плодах.
            - generic [ref=e124]:
              - generic [ref=e125]:
                - generic [ref=e129]: Верные
                - generic [ref=e136]: Неверные
              - generic [ref=e140]:
                - button "Плод относится к генеративным органам растения." [ref=e144] [cursor=pointer]:
                  - generic [ref=e146] [cursor=pointer]: Плод относится к генеративным органам растения.
                - button "Функция плода — защита и распространение семян." [ref=e150] [cursor=pointer]:
                  - generic [ref=e152] [cursor=pointer]: Функция плода — защита и распространение семян.
                - button "Плод образуется из цветка." [ref=e156] [cursor=pointer]:
                  - generic [ref=e158] [cursor=pointer]: Плод образуется из цветка.
                - button "Цвет плода зависит от его спелости. Спелые плоды красные." [ref=e162] [cursor=pointer]:
                  - generic [ref=e164] [cursor=pointer]: Цвет плода зависит от его спелости. Спелые плоды красные.
                - button "Внутри плода всегда одно семя." [ref=e168] [cursor=pointer]:
                  - generic [ref=e170] [cursor=pointer]: Внутри плода всегда одно семя.
                - button "Плод образуется у всех высших растений." [ref=e174] [cursor=pointer]:
                  - generic [ref=e176] [cursor=pointer]: Плод образуется у всех высших растений.
