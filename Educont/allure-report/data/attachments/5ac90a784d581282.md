      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            ...
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Впишите пропущенное слово (прилагательное).
            - generic [ref=e124]:
              - textbox [ref=e125]
              - text: рост — это долговременное увеличение реального объёма валового внутреннего продукта как в абсолютных значениях, так и в расчёте на каждого жителя страны.
