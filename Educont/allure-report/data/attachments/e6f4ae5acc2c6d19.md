        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Разнообразие природных сообществ. Искусственные сообщества" [ref=e32] [cursor=pointer]':
      ...
      - generic [ref=e86]:
        - region "Задача для решения" [ref=e88] [cursor=pointer]:
          - generic [ref=e91]:
            ...
            - generic [ref=e103]:
              - img "decore" [ref=e106]
              - generic [ref=e112]: Какую роль в жизни человека играют природные экосистемы?
            - generic [ref=e115]:
              - button "Добыча еды" [ref=e117] [cursor=pointer]:
                - generic [ref=e119] [cursor=pointer]: Добыча еды
              - button "Искусственное выращивание еды" [ref=e121] [cursor=pointer]:
                - generic [ref=e123] [cursor=pointer]: Искусственное выращивание еды
              - button "Регуляция климата" [ref=e125] [cursor=pointer]:
                - generic [ref=e127] [cursor=pointer]: Регуляция климата
