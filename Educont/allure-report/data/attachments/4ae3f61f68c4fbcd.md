          ...
          - region "Задача для решения" [ref=e137] [cursor=pointer]:
            - generic [ref=e138] [cursor=pointer]:
              - generic [ref=e141]:
                - generic [ref=e143]:
                  - img [ref=e147]
                  - heading "Распредели слова на 2 группы." [level=4] [ref=e149]:
                    - generic [ref=e151]: Распредели слова на 2 группы.
                - img "decore" [ref=e156]
                - generic [ref=e158]:
                  - generic [ref=e159]:
                    - generic [ref=e163]: в корне е
                    - generic [ref=e170]: в корне и
                  - generic [ref=e174]:
                    - button "ум_рать" [ref=e175]:
                      - button "ум_рать" [ref=e178] [cursor=pointer]:
                        - generic [ref=e180] [cursor=pointer]: ум_рать
                    - button "заб_рать" [ref=e181]:
                      - button "заб_рать" [ref=e184] [cursor=pointer]:
                        - generic [ref=e186] [cursor=pointer]: заб_рать
                    - button "зап_рать" [ref=e187]:
                      - button "зап_рать" [ref=e190] [cursor=pointer]:
                        - generic [ref=e192] [cursor=pointer]: зап_рать
                    - button "прот_реть" [ref=e193]:
                      - button "прот_реть" [ref=e196] [cursor=pointer]:
                        - generic [ref=e198] [cursor=pointer]: прот_реть
                    - button "отп_реть" [ref=e199]:
                      - button "отп_реть" [ref=e202] [cursor=pointer]:
                        - generic [ref=e204] [cursor=pointer]: отп_реть
                    - button "зам_реть" [ref=e205]:
                      - button "зам_реть" [ref=e208] [cursor=pointer]:
                        - generic [ref=e210] [cursor=pointer]: зам_реть
                    - button "уд_рать" [ref=e211]:
                      - button "уд_рать" [ref=e214] [cursor=pointer]:
                        - generic [ref=e216] [cursor=pointer]: уд_рать
                    - button "выб_ру" [ref=e217]:
                      - button "выб_ру" [ref=e220] [cursor=pointer]:
                        - generic [ref=e222] [cursor=pointer]: выб_ру
                  - status [ref=e223]
