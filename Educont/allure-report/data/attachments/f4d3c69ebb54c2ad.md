        ...
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              ...
              - heading "В конце какого предложения должен стоять восклицательный знак?" [level=4] [ref=e111]:
                - generic [ref=e113]:
                  - text: В конце какого предложения должен стоять
                  - strong [ref=e114]: восклицательный знак
                  - text: "?"
            - img "decore" [ref=e119]
            - generic [ref=e123]:
              - generic [ref=e126] [cursor=pointer]: Из леса возвращаются ребята.
              - generic [ref=e129] [cursor=pointer]: Они несут полные корзины грибов.
              - generic [ref=e132] [cursor=pointer]: Жарко идти полем.
              - generic [ref=e135] [cursor=pointer]: Скорей к реке.
