      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            ...
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Каков финал повести М.А. Булгакова «Собачье сердце»?
            - generic [ref=e122]:
              - generic [ref=e126] [cursor=pointer]: Профессор Преображенский попадает в тюрьму по доносу Шарикова.
              - generic [ref=e130] [cursor=pointer]: После доноса Шарикова профессор делает ему операцию, которая вновь превращает его в собаку.
              - generic [ref=e134] [cursor=pointer]: Шариков избавляется от вредных привычек и вступает в компартию.
