      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Распредели слова на две группы." [level=4] [ref=e112]:
                - generic [ref=e114]: Распредели слова на две группы.
            - img "decore" [ref=e119]
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: суффикс -ек
                - generic [ref=e133]: суффикс -ик
              - generic [ref=e137]:
                - button "стол_к" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: стол_к
                - button "замоч_к" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: замоч_к
                - button "винт_к" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: винт_к
                - button "носоч_к" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: носоч_к
                - button "клубоч_к" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: клубоч_к
                - button "мост_к" [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: мост_к
                - button "зонт_к" [ref=e177] [cursor=pointer]:
                  - generic [ref=e179] [cursor=pointer]: зонт_к
                - button "кусоч_к" [ref=e183] [cursor=pointer]:
                  - generic [ref=e185] [cursor=pointer]: кусоч_к
