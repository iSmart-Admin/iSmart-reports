      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            ...
            - generic [ref=e111]:
              - img "decore" [ref=e114]
              - generic [ref=e120]: Какие из предложенных симптомов относятся к проявлению гиповитаминоза витамина С?
            - generic [ref=e123]:
              - generic [ref=e127] [cursor=pointer]: Выпадение волос, появление язвы желудка, пожелтение глазных яблок.
              - generic [ref=e131] [cursor=pointer]: Выпадение зубов, кровоточивость дёсен, появление язв на коже.
