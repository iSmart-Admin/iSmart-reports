      ...
      - generic [ref=e92]:
        - region "Задача для решения" [ref=e94] [cursor=pointer]:
          - generic [ref=e97]:
            ...
            - generic [ref=e109]:
              - img "decore" [ref=e112]
              - generic [ref=e118]: Почему Обломов дистанцируется от гостей?
            - generic [ref=e121]:
              - button "Суетливую, деловую жизнь он не принимает" [ref=e123] [cursor=pointer]:
                - generic [ref=e125] [cursor=pointer]: Суетливую, деловую жизнь он не принимает
              - button "Он хочет сохранить свою независимость и покой" [ref=e127] [cursor=pointer]:
                - generic [ref=e129] [cursor=pointer]: Он хочет сохранить свою независимость и покой
              - button "Он не совсем здоров" [ref=e131] [cursor=pointer]:
                - generic [ref=e133] [cursor=pointer]: Он не совсем здоров
              - button "У него плохое настроение" [ref=e135] [cursor=pointer]:
                - generic [ref=e137] [cursor=pointer]: У него плохое настроение
        - button "1 Взять 1 подсказку" [ref=e146] [cursor=pointer]:
