      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Определи, какое это предложение по цели высказывания." [level=4] [ref=e112]:
                - generic [ref=e114]: Определи, какое это предложение по цели высказывания.
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - heading "Строительный кран подавал грузы." [level=3] [ref=e122]
            - generic [ref=e125]:
              - button "повествовательное" [ref=e127] [cursor=pointer]:
                - generic [ref=e129] [cursor=pointer]: повествовательное
              - button "вопросительное" [ref=e131] [cursor=pointer]:
                - generic [ref=e133] [cursor=pointer]: вопросительное
              - button "побудительное" [ref=e135] [cursor=pointer]:
                - generic [ref=e137] [cursor=pointer]: побудительное
