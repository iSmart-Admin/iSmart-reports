      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Два точечных источника света находятся близко друг от друга и создают на удалённом экране устойчивую интерференционную картину. Это возможно, если эти два источника являются ……………
            - generic [ref=e118]:
              - generic [ref=e120] [cursor=pointer]: двумя солнечными зайчиками от разных зеркал
              - generic [ref=e122] [cursor=pointer]: двумя лампами накаливания
              - generic [ref=e124] [cursor=pointer]: малыми отверстиями в непрозрачном экране, освещёнными светом одного и того же точечного источника
              - generic [ref=e126] [cursor=pointer]: малыми отверстиями в непрозрачном экране, освещёнными светом двух точечных источников разных цветов
