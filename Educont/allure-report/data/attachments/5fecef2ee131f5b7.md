      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            - generic [ref=e100]:
              - img [ref=e104]
              - heading "Установи соответствие между элементами." [level=4] [ref=e106]:
                - generic [ref=e108]: Установи соответствие между элементами.
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Установи соответствие между типом кровеносной системы и животным.
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: Замкнутая кровеносная система
                - generic [ref=e133]: Незамкнутая кровеносная система
              - generic [ref=e137]:
                - button "Муравей" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: Муравей
                - button "Дождевой червь" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Дождевой червь
                - button "Кошка" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Кошка
                - button "Прудовик" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: Прудовик
                - button "Комар" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Комар
