        ...
        - region "Задача для решения" [ref=e85] [cursor=pointer]:
          - generic [ref=e86] [cursor=pointer]:
            - generic [ref=e89]:
              - generic [ref=e91]:
                - img [ref=e95]
                - heading "Внеси ответ в специально предназначенное поле." [level=4] [ref=e97]:
                  - generic [ref=e99]: Внеси ответ в специально предназначенное поле.
              - generic [ref=e101]:
                - img "decore" [ref=e104]
                - generic [ref=e110]: Как называется в литературе описание внешности героя?
              - generic [ref=e112]:
                - generic [ref=e121]:
                  - button "Р" [ref=e122] [cursor=pointer]
                  - button "О" [ref=e123] [cursor=pointer]
                  - button "П" [ref=e124] [cursor=pointer]
                  - button "Е" [ref=e125] [cursor=pointer]
                  - button "Т" [ref=e126] [cursor=pointer]
                - status [ref=e127]
