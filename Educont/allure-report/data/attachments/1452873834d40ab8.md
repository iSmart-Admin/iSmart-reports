      ...
      - generic [ref=e90]:
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - img "decore" [ref=e110]
            - generic [ref=e114]:
              - generic [ref=e121] [cursor=pointer]: Чем меньше меняется скорость тела при взаимодействии, тем большую массу оно имеет. Такое тело называют более инертным.
              - generic [ref=e128] [cursor=pointer]: Чем меньше меняется скорость тела при взаимодействии, тем меньшую массу оно имеет. Такое тело называют более инертным.
              - generic [ref=e135] [cursor=pointer]: Чем больше меняется скорость тела при взаимодействии, тем большую массу оно имеет. Такое тело называют более инертным.
              - generic [ref=e142] [cursor=pointer]: Чем больше меняется скорость тела при взаимодействии, тем меньшую массу оно имеет. Такое тело называют менее инертным.
