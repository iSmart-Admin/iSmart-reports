      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Выбери предложение, в котором глагол стоит в настоящем времени." [level=4] [ref=e112]:
                - generic [ref=e114]: Выбери предложение, в котором глагол стоит в настоящем времени.
            - img "decore" [ref=e119]
            - generic [ref=e122]:
              - button "Хищный ястреб кружил над полем в поисках добычи." [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Хищный ястреб кружил над полем в поисках добычи.
              - button "Яркая луна отражается в зеркальной поверхности лесного озера." [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Яркая луна отражается в зеркальной поверхности лесного озера.
              - button "Голосистые соловьи будут напевать в рощицах радостные песенки." [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: Голосистые соловьи будут напевать в рощицах радостные песенки.
