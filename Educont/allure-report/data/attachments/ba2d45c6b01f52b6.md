      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e116]:
              - button "Разницу между работой и удовольствием." [ref=e118] [cursor=pointer]:
                - generic [ref=e120] [cursor=pointer]: Разницу между работой и удовольствием.
              - button "Работа — то, что не приносит удовольствия." [ref=e122] [cursor=pointer]:
                - generic [ref=e124] [cursor=pointer]: Работа — то, что не приносит удовольствия.
              - button "Изготовлять цветы — работа." [ref=e126] [cursor=pointer]:
                - generic [ref=e128] [cursor=pointer]: Изготовлять цветы — работа.
        - button "1 Взять 1 подсказку" [ref=e137] [cursor=pointer]:
