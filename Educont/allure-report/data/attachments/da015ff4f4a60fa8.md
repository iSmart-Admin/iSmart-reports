  ...
  - generic [ref=e13]:
    - generic [ref=e16]:
      ...
      - generic [ref=e25]:
        ...
        - generic [ref=e37]:
          - img "decore" [ref=e40]
          - generic [ref=e46]: Нормальное восприятие запаха и вкуса у человека будет при условии, если?
        - generic [ref=e49]:
          - generic [ref=e53] [cursor=pointer]: Слизистая языка увлажнена.
          - generic [ref=e57] [cursor=pointer]: Поверхность языка сухая.
          - generic [ref=e61] [cursor=pointer]: Эпителий носовых ходов выделяет большое количество слизи.
          - generic [ref=e65] [cursor=pointer]: Слизистая носа и языка одновременно нормально функционируют.
