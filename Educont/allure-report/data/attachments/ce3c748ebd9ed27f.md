        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Морфологический анализ частицы. Повторение" [ref=e32] [cursor=pointer]':
          ...
          - generic [ref=e89]:
            ...
            - generic [ref=e96]:
              ...
              - link "личном кабинете iSmart." [ref=e97] [cursor=pointer]:
                - /url: /schools/68de8222b0019c00074daee3/employees/697b2f4a647bc60007c5f333/classes
            - button "Настроить класс для аналитики" [ref=e98] [cursor=pointer]:
              - generic [ref=e99] [cursor=pointer]: Настроить класс для аналитики
          - generic [ref=e100]:
            - button "Заметки к уроку видны только вам" [ref=e101] [cursor=pointer]:
              - generic [ref=e102] [cursor=pointer]:
                - img [ref=e104] [cursor=pointer]
                - generic [ref=e106] [cursor=pointer]: Заметки к уроку
              - button "видны только вам" [ref=e107] [cursor=pointer]:
                - img [ref=e109] [cursor=pointer]
            - button "Часто задаваемые вопросы" [ref=e111] [cursor=pointer]:
              - generic [ref=e112] [cursor=pointer]:
                - img [ref=e114] [cursor=pointer]
                - generic [ref=e116] [cursor=pointer]: Часто задаваемые вопросы
            - button "Сообщить об ошибке" [ref=e117] [cursor=pointer]:
              - generic [ref=e118] [cursor=pointer]:
                - img [ref=e120] [cursor=pointer]
                - generic [ref=e122] [cursor=pointer]: Сообщить об ошибке
        - generic [ref=e123] [cursor=pointer]:
          - generic [ref=e124] [cursor=pointer]:
            - img "schoolIcon" [ref=e125] [cursor=pointer]
            - generic [ref=e126] [cursor=pointer]: Тест educont 2
          - link "Перейти в личный кабинет" [ref=e127] [cursor=pointer]:
            - /url: /schools/68de8222b0019c00074daee3/employees/697b2f4a647bc60007c5f333/classes
      ...
      - generic [ref=e133]:
        - region "Задача для решения" [ref=e135] [cursor=pointer]:
          - generic [ref=e138]:
            - generic [ref=e140]:
              - img [ref=e144]
              - heading "Укажи цифры, соответствующие раздельному написанию с «не» причастий. Цифры указывай в порядке возрастания, без пробелов." [level=4] [ref=e146]:
                - generic [ref=e147]:
                  - generic [ref=e148]: Укажи цифры, соответствующие раздельному написанию с «не» причастий.
                  - generic [ref=e149]: Цифры указывай в порядке возрастания, без пробелов.
            - generic [ref=e151]:
              - img "decore" [ref=e154]
              - generic [ref=e159]:
                - generic [ref=e160]: Учёные обнаружили никем не (1) исследованный участок перуанского Мачу-Пикчу — древнего города, находящегося на вершине горного хребта на высоте 2450 метров над уровнем моря.
                - generic [ref=e161]: Только не (2) заинтересованному взгляду русская природа кажется бедной. Всех возмутил ничем не (3) оправданный поступок Кости. Статья о творчестве известного поэта не (4) отредактирована.
            - generic [ref=e169]:
              - text: "Ответ:"
              - textbox [ref=e170]
              - text: .
