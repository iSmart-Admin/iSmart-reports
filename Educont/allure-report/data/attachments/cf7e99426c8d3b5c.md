      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Отметь строку, на которой записано предложение." [level=4] [ref=e112]:
                - generic [ref=e114]: Отметь строку, на которой записано предложение.
            - img "decore" [ref=e119]
            - generic [ref=e122]:
              - button "Ветер, дерево, качели, сильный." [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Ветер, дерево, качели, сильный.
              - button "Сильный ветер качает деревья." [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Сильный ветер качает деревья.
