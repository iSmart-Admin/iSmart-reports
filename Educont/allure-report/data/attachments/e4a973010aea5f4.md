      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Выбери и укажи строку, в которой записано сложноподчинённое предложение." [level=4] [ref=e112]:
                - generic [ref=e114]: Выбери и укажи строку, в которой записано сложноподчинённое предложение.
            - img "decore" [ref=e119]
            - generic [ref=e122]:
              - generic [ref=e124] [cursor=pointer]:
                - generic [ref=e128] [cursor=pointer]: Было так тихо, как только бывает в лесу в безветренный день.
                - emphasis [ref=e133] [cursor=pointer]: (А.И. Куприн)
              - generic [ref=e135] [cursor=pointer]:
                - generic [ref=e139] [cursor=pointer]: Девушка бросает на копну деревянные грабли.
                - emphasis [ref=e144] [cursor=pointer]: (В. Песков)
              - generic [ref=e146] [cursor=pointer]:
                - generic [ref=e150] [cursor=pointer]: Липовый лёгкий лист разметало по улицам и тротуарам, а тополёвый лежал кругами возле деревьев, серея шершавой изнанкой.
                - emphasis [ref=e155] [cursor=pointer]: (В.П. Астафьев)
