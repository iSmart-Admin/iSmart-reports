        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Работа с единицами длины" [ref=e32] [cursor=pointer]':
            ...
            - button "Редактировать урок" [ref=e104] [cursor=pointer]
          - generic [ref=e105]:
            - generic [ref=e106]:
              - generic [ref=e107]: Отчёты и аналитика
              - img "Для учителей" [ref=e108] [cursor=pointer]:
                - img [ref=e110] [cursor=pointer]
            - generic [ref=e112]:
              - text: Заведите класс и пригласите учеников по кодам, чтобы смотреть результаты заданий и общую динамику класса в
              - link "личном кабинете iSmart." [ref=e113] [cursor=pointer]:
                - /url: /schools/68de8222b0019c00074daee3/employees/697b2f4a647bc60007c5f333/classes
            - button "Настроить класс для аналитики" [ref=e114] [cursor=pointer]:
              - generic [ref=e115] [cursor=pointer]: Настроить класс для аналитики
          - generic [ref=e116]:
            - button "Заметки к уроку видны только вам" [ref=e117] [cursor=pointer]:
              - generic [ref=e118] [cursor=pointer]:
                - img [ref=e120] [cursor=pointer]
                - generic [ref=e122] [cursor=pointer]: Заметки к уроку
              - button "видны только вам" [ref=e123] [cursor=pointer]:
                - img [ref=e125] [cursor=pointer]
            - button "Часто задаваемые вопросы" [ref=e127] [cursor=pointer]:
              - generic [ref=e128] [cursor=pointer]:
                - img [ref=e130] [cursor=pointer]
                - generic [ref=e132] [cursor=pointer]: Часто задаваемые вопросы
            - button "Сообщить об ошибке" [ref=e133] [cursor=pointer]:
              - generic [ref=e134] [cursor=pointer]:
                - img [ref=e136] [cursor=pointer]
                - generic [ref=e138] [cursor=pointer]: Сообщить об ошибке
        - generic [ref=e139] [cursor=pointer]:
          - generic [ref=e140] [cursor=pointer]:
            - img "schoolIcon" [ref=e141] [cursor=pointer]
            - generic [ref=e142] [cursor=pointer]: Тест educont 2
          - link "Перейти в личный кабинет" [ref=e143] [cursor=pointer]:
            - /url: /schools/68de8222b0019c00074daee3/employees/697b2f4a647bc60007c5f333/classes
            - img [ref=e145] [cursor=pointer]
      - generic [ref=e149]:
        - region "Задача для решения" [ref=e151] [cursor=pointer]:
          - generic [ref=e154]:
            - generic [ref=e156]:
              - img [ref=e160]
              - heading "Переведи метры в дециметры." [level=4] [ref=e162]:
                - generic [ref=e164]:
                  - text: Переведи
                  - strong [ref=e165]: метры
                  - text: в
                  - strong [ref=e166]: дециметры
                  - text: .
            - img "decore" [ref=e171]
            - heading "44 м = дм" [level=2] [ref=e176]:
              - text: 44 м =
              - textbox [ref=e177]
              - text: дм
