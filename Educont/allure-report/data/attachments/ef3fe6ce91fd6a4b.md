      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - 'heading "Распредели предложения в две группы: распространённые и нераспространённые." [level=4] [ref=e107]':
                - generic [ref=e109]: "Распредели предложения в две группы: распространённые и нераспространённые."
            - img "decore" [ref=e114]
            - generic [ref=e116]:
              - generic [ref=e117]:
                - generic [ref=e121]: Распространённые предложения
                - generic [ref=e128]: Нераспространённые предложения
              - generic [ref=e132]:
                - button "Дети поют, танцуют." [ref=e136] [cursor=pointer]:
                  - generic [ref=e138] [cursor=pointer]: Дети поют, танцуют.
                - button "Чайки кружат над морем." [ref=e142] [cursor=pointer]:
                  - generic [ref=e144] [cursor=pointer]: Чайки кружат над морем.
                - button "Ребята увидели соловья." [ref=e148] [cursor=pointer]:
                  - generic [ref=e150] [cursor=pointer]: Ребята увидели соловья.
                - button "Море волнуется." [ref=e154] [cursor=pointer]:
                  - generic [ref=e156] [cursor=pointer]: Море волнуется.
