        ...
        - region "Задача для решения" [ref=e91] [cursor=pointer]:
          - generic [ref=e94]:
            ...
            - generic [ref=e106]:
              - img "decore" [ref=e109]
              - generic [ref=e112]:
                - generic [ref=e115]: У срубле(1)ого дерева сидел седой старик в дли(2)ой рубахе, подпояса(3)ой истрёпа(4)ым кожа(5)ым поясом, и держал в руках пойма(6)ую дикую утку.
                - generic [ref=e118]: Укажите все цифры(у), на месте которых(ой) пишется Н.
            - generic [ref=e122]:
              - generic [ref=e123]: Цифры записывайте по порядку без пробелов.
              - generic [ref=e124]:
