      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Соотнеси понятия с их характеристиками.
            - generic [ref=e128]:
              - img [ref=e129]
              - generic [ref=e130]:
                - generic [ref=e136] [cursor=pointer]: Сложна по содержанию, трудна для понимания обычным человеком. Не направлена на получение коммерческой выгоды.
                - generic [ref=e143] [cursor=pointer]: Массовая культура
              - generic [ref=e144]:
                - generic [ref=e150] [cursor=pointer]: Проста и понятна по содержанию. Чаще всего имеет бытовые сюжеты. Не направлена на получение коммерческой выгоды.
                - generic [ref=e157] [cursor=pointer]: Народная культура
              - generic [ref=e158]:
                - generic [ref=e164] [cursor=pointer]: Главная цель — получение коммерческой выгоды. Понятна и доступна всем. Имеет низкую духовную ценность, отвечает сиюминутным запросам человека.
                - generic [ref=e171] [cursor=pointer]: Элитарная культура
