  ...
  - generic [ref=e13]:
    - generic [ref=e16]:
      ...
      - generic [ref=e25]:
        ...
        - generic [ref=e37]:
          - img "decore" [ref=e40]
          - generic [ref=e46]: Одна из важных проблем современной экологии — борьба с критическим изменением климата. Выбери газы, которые сильнее всего влияют на измненение температуры на Земле.
        - generic [ref=e49]:
          - generic [ref=e53] [cursor=pointer]: Углекислый
          - generic [ref=e57] [cursor=pointer]: Метан
          - generic [ref=e61] [cursor=pointer]: Азот
          - generic [ref=e65] [cursor=pointer]: Кислород
