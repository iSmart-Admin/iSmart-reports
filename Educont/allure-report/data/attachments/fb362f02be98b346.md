      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Выбери определение понятия «Абсолютизм».
            - generic [ref=e128]:
              - button "Такая форма правления, при которой монарху принадлежит вся полнота власти в государстве." [ref=e130] [cursor=pointer]:
                - generic [ref=e132] [cursor=pointer]: Такая форма правления, при которой монарху принадлежит вся полнота власти в государстве.
              - button "Форма взаимодействия церкви и светской власти, при которой глава церкви одновременно управляет и церковью, и государством." [ref=e134] [cursor=pointer]:
                - generic [ref=e136] [cursor=pointer]: Форма взаимодействия церкви и светской власти, при которой глава церкви одновременно управляет и церковью, и государством.
        - button "1 Взять 1 подсказку" [ref=e145] [cursor=pointer]:
