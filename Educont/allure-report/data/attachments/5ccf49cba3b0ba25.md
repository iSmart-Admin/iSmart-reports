        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Конденсатор" [ref=e32] [cursor=pointer]':
      ...
      - generic [ref=e88]:
        - region "Задача для решения" [ref=e90] [cursor=pointer]:
          - generic [ref=e93]:
            ...
            - generic [ref=e105]:
              - img "decore" [ref=e108]
              - generic [ref=e114]: Каким образом можно увеличить ёмкость конденсатора?
            - generic [ref=e117]:
              - button "Увеличить размер конденсатора" [ref=e119] [cursor=pointer]:
                - generic [ref=e121] [cursor=pointer]: Увеличить размер конденсатора
              - button "Увеличить площадь обкладок" [ref=e123] [cursor=pointer]:
                - generic [ref=e125] [cursor=pointer]: Увеличить площадь обкладок
              - button "Уменьшить расстояние между обкладками" [ref=e127] [cursor=pointer]:
                - generic [ref=e129] [cursor=pointer]: Уменьшить расстояние между обкладками
              - button "Заменить используемый диэлектрик, на диэлектрик с большей диэлектрической проницаемостью." [ref=e131] [cursor=pointer]:
                - generic [ref=e133] [cursor=pointer]: Заменить используемый диэлектрик, на диэлектрик с большей диэлектрической проницаемостью.
