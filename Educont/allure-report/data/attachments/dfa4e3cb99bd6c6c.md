      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Определи главные и второстепенные члены предложения." [level=4] [ref=e112]:
                - generic [ref=e114]: Определи главные и второстепенные члены предложения.
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - heading "Петя по утрам плавает в глубоком бассейне." [level=3] [ref=e122]
            - generic [ref=e124]:
              - generic [ref=e125]:
                - generic [ref=e129]: Главные члены предложения
                - generic [ref=e136]: Второстепенные члены предложения
              - generic [ref=e140]:
                - button "плавает" [ref=e144] [cursor=pointer]:
                  - generic [ref=e146] [cursor=pointer]: плавает
                - button "глубоком" [ref=e150] [cursor=pointer]:
                  - generic [ref=e152] [cursor=pointer]: глубоком
                - button "в бассейне" [ref=e156] [cursor=pointer]:
                  - generic [ref=e158] [cursor=pointer]: в бассейне
                - button "Петя" [ref=e162] [cursor=pointer]:
                  - generic [ref=e164] [cursor=pointer]: Петя
                - button "по утрам" [ref=e168] [cursor=pointer]:
                  - generic [ref=e170] [cursor=pointer]: по утрам
