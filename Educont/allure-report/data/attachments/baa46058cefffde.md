        ...
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e102] [cursor=pointer]:
            - generic [ref=e105]:
              - generic [ref=e107]:
                - img [ref=e111]
                - heading "Выберите все верные варианты ответа." [level=4] [ref=e113]:
                  - generic [ref=e115]: Выберите все верные варианты ответа.
              - generic [ref=e117]:
                - img "decore" [ref=e120]
                - generic [ref=e126]: В чём разница между понятиями «биоценоз» и «экосистема»?
              - generic [ref=e131]:
                - generic [ref=e133] [cursor=pointer]: Биоценоз включает только организмы и их взаимодействие с окружающей средой.
                - generic [ref=e135] [cursor=pointer]: Биоценоз не включает в себя факторы среды.
                - generic [ref=e137] [cursor=pointer]: Экосистема это часть биоценоза, его условия.
                - generic [ref=e139] [cursor=pointer]: Экосистема — условия обитания организмов, то есть биоценозов.
                - generic [ref=e141] [cursor=pointer]: Экосистема — более широкое понятие, включающее в себя и организмы и условия среды, где они живут.
                - generic [ref=e143] [cursor=pointer]: Экосистема — более узкое понятие, включающее в себя только условия, в которых обитают организмы.
