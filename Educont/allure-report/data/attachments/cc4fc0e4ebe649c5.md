      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Разложение пучка солнечного света в спектр при прохождении его через призму объясняется тем, что свет состоит из набора электромагнитных волн разной длины которые попадают в призму и ………..
            - generic [ref=e118]:
              - generic [ref=e120] [cursor=pointer]: движутся с разной скоростью
              - generic [ref=e122] [cursor=pointer]: имеют одинаковую частоту
              - generic [ref=e124] [cursor=pointer]: поглощаются в разной степени
              - generic [ref=e126] [cursor=pointer]: имеют одинаковую длину волны
