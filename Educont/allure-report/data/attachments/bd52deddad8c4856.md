        ...
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e102] [cursor=pointer]:
            - generic [ref=e105]:
              - generic [ref=e107]:
                - img [ref=e111]
                - heading "Выбери строчку, в которой все наречия пишутся через дефис." [level=4] [ref=e113]:
                  - generic [ref=e115]: Выбери строчку, в которой все наречия пишутся через дефис.
              - img "decore" [ref=e120]
              - generic [ref=e124]:
                - generic [ref=e127] [cursor=pointer]: точь (в) точь выполнить, разделить (по)полам
                - generic [ref=e130] [cursor=pointer]: разделиться (по)двое, жить (за)границей
                - generic [ref=e133] [cursor=pointer]: (по)детски распахнув глаза, размеренно (по)дачному
