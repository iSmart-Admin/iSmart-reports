      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Выберите специфические черты и признаки современной науки.
            - generic [ref=e130]:
              - generic [ref=e132] [cursor=pointer]: Современная наука сосредоточена на изучении фундаментальных законов природы и общества.
              - generic [ref=e134] [cursor=pointer]: Современные исследования сложно представить без использования специализированного оборудования и программ.
              - generic [ref=e136] [cursor=pointer]: Обмен научной информацией происходит мгновенно благодаря интернету и другим средствам коммуникации.
              - generic [ref=e138] [cursor=pointer]: Учёные полагаются на наблюдения и эксперименты как на основной источник знаний, а теоретические построения играют второстепенную роль.
              - generic [ref=e140] [cursor=pointer]: Современные научные исследования носят описательный характер, так как учёные собирают и систематизируют факты, но не пытаются объяснить их с помощью теорий или гипотез.
              - generic [ref=e142] [cursor=pointer]: С развитием науки возникают новые этические вопросы, связанные с использованием научных достижений, например, клонирование, искусственный интеллект.
