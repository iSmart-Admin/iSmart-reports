      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            ...
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Что из перечисленного не является преступлением?
            - generic [ref=e122]:
              - button "Кража" [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Кража
              - button "Убийство" [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Убийство
              - button "Оскорбление" [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: Оскорбление
              - button "Причинение вреда здоровью" [ref=e136] [cursor=pointer]:
                - generic [ref=e138] [cursor=pointer]: Причинение вреда здоровью
              - button "Клевета" [ref=e140] [cursor=pointer]:
                - generic [ref=e142] [cursor=pointer]: Клевета
