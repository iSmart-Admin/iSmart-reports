      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Распредели жанры по периодам.
            - generic [ref=e127]:
              - generic [ref=e128]:
                - generic [ref=e132]: Древнерусская литература
                - generic [ref=e139]: Литература XVIII – XXI вв.
              - generic [ref=e143]:
                - button "Роман" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Роман
                - button "Летопись" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Летопись
                - button "Житие" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: Житие
                - button "Новелла" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Новелла
                - button "Сонет" [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: Сонет
                - button "Слово" [ref=e177] [cursor=pointer]:
                  - generic [ref=e179] [cursor=pointer]: Слово
                - button "Хожение (хождение)" [ref=e183] [cursor=pointer]:
                  - generic [ref=e185] [cursor=pointer]: Хожение (хождение)
                - button "Элегия" [ref=e189] [cursor=pointer]:
                  - generic [ref=e191] [cursor=pointer]: Элегия
