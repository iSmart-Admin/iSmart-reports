      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Выпиши цифры, на месте которых нужно поставить тире. Цифры записывай в порядке возрастания, без пробелов." [level=4] [ref=e112]:
                - generic [ref=e113]:
                  - generic [ref=e114]: Выпиши цифры, на месте которых нужно поставить тире.
                  - generic [ref=e115]: Цифры записывай в порядке возрастания, без пробелов.
            - generic [ref=e117]:
              - img "decore" [ref=e120]
              - generic [ref=e126]: Иван Алексеевич (1) талантливый учёный. Да, он (2) человек нехозяйственный, убраться в квартире (3) задача для него непосильная, но каждый (4) имеет недостатки.
            - generic [ref=e134]:
              - text: "Ответ:"
