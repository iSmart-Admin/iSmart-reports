      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "Укажи цифры, соответствующие слитному написанию с «не» наречий. Цифры указывай в порядке возрастания, без пробелов." [level=4] [ref=e107]:
                - generic [ref=e108]:
                  - generic [ref=e109]: Укажи цифры, соответствующие слитному написанию с «не» наречий.
                  - generic [ref=e110]: Цифры указывай в порядке возрастания, без пробелов.
            - generic [ref=e112]:
              - img "decore" [ref=e115]
              - generic [ref=e120]:
                - generic [ref=e121]:
                  - text: На задних партах не(1)уверенно хихикнули.
                  - emphasis [ref=e122]: (По Л. Платову)
                - generic [ref=e123]:
                  - text: Толстоносов топтался у карты и не(2)решительно тыкал пальцем куда-то между Уралом и Волгой.
                  - emphasis [ref=e124]: (По Л. Платову)
                - generic [ref=e125]: Не(3)впервые мне приходилось видеть ракеты.
                - generic [ref=e126]: В правилах Морозова — появляться зачастую не(4)чаянно.
            - generic [ref=e134]:
              - text: "Ответ:"
              - textbox [ref=e135]
              - text: .
