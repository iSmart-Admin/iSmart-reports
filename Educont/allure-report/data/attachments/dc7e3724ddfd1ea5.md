        ...
        - region "Задача для решения" [ref=e26] [cursor=pointer]:
          - generic [ref=e27] [cursor=pointer]:
            ...
            - generic [ref=e57]:
              ...
              - generic [ref=e69]:
                - img "decore" [ref=e72]
                - generic [ref=e78]: Что НЕ является примером административных отношений?
              - generic [ref=e81]:
                - generic [ref=e85] [cursor=pointer]: Сотрудник ГИБДД проверил документы у водителя
                - generic [ref=e89] [cursor=pointer]: Представитель пожарного надзора выписал штраф владельцу магазина
                - generic [ref=e93] [cursor=pointer]: Минобрнауки совместно с Минприроды разработали программу дисциплины «Экология»
                - generic [ref=e97] [cursor=pointer]: Начальник сделал выговор сотруднику за прогул
        - generic [ref=e102]:
          - generic [ref=e105]:
