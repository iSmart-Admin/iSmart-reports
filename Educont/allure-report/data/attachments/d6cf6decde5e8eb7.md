        ...
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - generic [ref=e118]:
              ...
              - generic [ref=e141]:
                - button "Нитрит натрия и серная кислота (разб.)" [ref=e145] [cursor=pointer]:
                  - generic [ref=e147] [cursor=pointer]: Нитрит натрия и серная кислота (разб.)
                - button "Карбонат натрия и соляная кислота" [ref=e151] [cursor=pointer]:
                  - generic [ref=e153] [cursor=pointer]: Карбонат натрия и соляная кислота
                - button "Силикат калия и нитрат кальция" [ref=e157] [cursor=pointer]:
                  - generic [ref=e159] [cursor=pointer]: Силикат калия и нитрат кальция
                - button "Хлорид натрия и нитрат серебра" [ref=e163] [cursor=pointer]:
                  - generic [ref=e165] [cursor=pointer]: Хлорид натрия и нитрат серебра
                - button "Сульфид железа (II) и соляная кислота" [ref=e169] [cursor=pointer]:
                  - generic [ref=e171] [cursor=pointer]: Сульфид железа (II) и соляная кислота
