        ...
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - generic [ref=e107]:
              - img "decore" [ref=e110]
              - generic [ref=e112]:
                - img "кч рыхление" [ref=e115]
                - generic [ref=e119]: Выбери из предложенного три верных утверждения, относящиеся к значению кольчатых червей в повышении урожайности растений.
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: Верно
                - generic [ref=e133]: Неверно
              - generic [ref=e137]:
                - button "Засоление почвы" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: Засоление почвы
                - button "Эрозия почвы" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Эрозия почвы
                - button "Рыхление почвы" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Рыхление почвы
                - button "Распространение яиц гельминтов" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: Распространение яиц гельминтов
                - button "Образование гумуса" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Образование гумуса
                - button "Обогащение почвы кислородом и питательными веществами" [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: Обогащение почвы кислородом и питательными веществами
