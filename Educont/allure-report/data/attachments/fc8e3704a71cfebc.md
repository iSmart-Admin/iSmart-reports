      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Распределите свойства процессов по колонкам.
            - generic [ref=e115]:
              - generic [ref=e116]:
                - generic [ref=e120]: "Испарение происходит:"
                - generic [ref=e127]: "Кипение происходит:"
              - generic [ref=e131]:
                - button "По всему объёму жидкости" [ref=e135] [cursor=pointer]:
                  - generic [ref=e137] [cursor=pointer]: По всему объёму жидкости
                - button "При определённой температуре" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: При определённой температуре
                - button "Температура зависит от давления атмосферы" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Температура зависит от давления атмосферы
                - button "При любой температуре" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: При любой температуре
                - button "С поверхности жидкости" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: С поверхности жидкости
                - button "Скорость процесса тем выше, чем выше температура" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Скорость процесса тем выше, чем выше температура
