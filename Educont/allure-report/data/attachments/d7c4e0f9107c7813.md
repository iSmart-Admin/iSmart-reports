      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "В какой строке перечислены только служебные части речи?" [level=4] [ref=e107]:
                - generic [ref=e109]:
                  - text: В какой строке перечислены только
                  - strong [ref=e110]: служебные
                  - text: части речи?
            - img "decore" [ref=e115]
            - generic [ref=e118]:
              - button "верность, ярко, ты" [ref=e120] [cursor=pointer]:
                - generic [ref=e122] [cursor=pointer]: верность, ярко, ты
              - button "одиннадцать, выше, крепость" [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: одиннадцать, выше, крепость
              - button "над, про, но" [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: над, про, но
              - button "заря, родина, лесной" [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: заря, родина, лесной
