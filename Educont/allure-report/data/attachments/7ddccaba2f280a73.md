      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "Распредели слова в два столбика." [level=4] [ref=e112]:
                - generic [ref=e114]: Распредели слова в два столбика.
            - img "decore" [ref=e119]
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: Единственное число
                - generic [ref=e133]: Множественное число
              - generic [ref=e137]:
                - button "з е ́ мли" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]:
                    - text: з
                    - generic [ref=e144] [cursor=pointer]: е ́
                    - text: мли
                - button "навыки" [ref=e148] [cursor=pointer]:
                  - generic [ref=e150] [cursor=pointer]: навыки
                - button "площади" [ref=e154] [cursor=pointer]:
                  - generic [ref=e156] [cursor=pointer]: площади
                - button "терпение" [ref=e160] [cursor=pointer]:
                  - generic [ref=e162] [cursor=pointer]: терпение
                - button "кров" [ref=e166] [cursor=pointer]:
                  - generic [ref=e168] [cursor=pointer]: кров
                - button "планета" [ref=e172] [cursor=pointer]:
                  - generic [ref=e174] [cursor=pointer]: планета
                - button "воздух" [ref=e178] [cursor=pointer]:
                  - generic [ref=e180] [cursor=pointer]: воздух
                - button "формы" [ref=e184] [cursor=pointer]:
                  - generic [ref=e186] [cursor=pointer]: формы
