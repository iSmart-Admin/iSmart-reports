...
- generic [ref=e5]:
  ...
  - generic:
    - generic:
      - generic [ref=e294]:
        - generic [ref=e295]:
          - generic [ref=e296]: Меню разработчика
          - button [ref=e298] [cursor=pointer]:
            - img [ref=e300] [cursor=pointer]
        - button "Выйти из тренажера" [ref=e302] [cursor=pointer]
        - button "Финальная статистика" [ref=e303] [cursor=pointer]
      - generic [ref=e307]:
        - generic [ref=e308]:
          - region "Задача для решения" [ref=e310] [cursor=pointer]:
            - generic [ref=e311] [cursor=pointer]:
              - button "Вернуться обратно к подборке" [ref=e314] [cursor=pointer]:
                - img [ref=e317] [cursor=pointer]
                - text: Вернуться обратно к подборке
              - generic [ref=e320]:
                - generic [ref=e322]:
                  - img [ref=e326]
                  - heading "Внесите ответ в специально предназначенное поле." [level=4] [ref=e328]:
                    - generic [ref=e330]: Внесите ответ в специально предназначенное поле.
                - generic [ref=e332]:
                  - img "decore" [ref=e335]
                  - generic [ref=e337]:
                    - generic [ref=e341]: На представленной ниже схеме ученик зафиксировал один из процессов жизнедеятельности растений. Как называют данный процесс?
                    - img "bio.v6.1.1u_Дыхание растений" [ref=e344]
                - generic [ref=e348]:
                  - generic [ref=e349]: Впишите ответ в поле ответов в именительном падеже.
                  - generic [ref=e350]:
        ...
        - generic [ref=e385]:
          ...
          - generic [ref=e404]:
            ...
            - generic [ref=e421]:
              ...
              - generic [ref=e428]: 69cd0cfee7dddf00073261fa
```