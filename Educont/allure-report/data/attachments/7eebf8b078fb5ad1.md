      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Распределите признаки норм морали и права.
            - generic [ref=e127]:
              - generic [ref=e128]:
                - generic [ref=e132]: Нормы морали
                - generic [ref=e139]: Нормы права
              - generic [ref=e143]:
                - button "Выражены в письменной форме и имеют чёткую структуру." [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Выражены в письменной форме и имеют чёткую структуру.
                - button "Соблюдение основано на внутреннем убеждении человека." [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Соблюдение основано на внутреннем убеждении человека.
                - button "Обязательны для исполнения всеми субъектами, находящимися в сфере их действия, независимо от их желания." [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: Обязательны для исполнения всеми субъектами, находящимися в сфере их действия, независимо от их желания.
                - button "Устанавливаются или санкционируются государством и обеспечиваются его принудительной силой." [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Устанавливаются или санкционируются государством и обеспечиваются его принудительной силой.
                - button "Оценивают поступки людей с точки зрения добра и зла, справедливости и несправедливости." [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: Оценивают поступки людей с точки зрения добра и зла, справедливости и несправедливости.
                - button "Не имеют формального закрепления в виде законов или правил, существуют в сознании людей и передаются из поколения в поколение." [ref=e177] [cursor=pointer]:
                  - generic [ref=e179] [cursor=pointer]: Не имеют формального закрепления в виде законов или правил, существуют в сознании людей и передаются из поколения в поколение.
