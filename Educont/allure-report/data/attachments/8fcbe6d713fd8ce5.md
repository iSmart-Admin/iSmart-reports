      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Распредели верные и неверные утверждения о строении цветка.
            - generic [ref=e127]:
              - generic [ref=e128]:
                - generic [ref=e132]: Верно
                - generic [ref=e139]: Неверно
              - generic [ref=e143]:
                - button "Околоцветник состоящий только из чашелистиков — одинарный." [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: Околоцветник состоящий только из чашелистиков — одинарный.
                - button "Функция околоцветника — привлечение опылителей и защита тычинок и пестиков." [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: Функция околоцветника — привлечение опылителей и защита тычинок и пестиков.
                - button "У цветка могут быть или лепестки, или чашелистики." [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: У цветка могут быть или лепестки, или чашелистики.
                - button "Функция лепестков — вырабатывать пыльцу." [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: Функция лепестков — вырабатывать пыльцу.
                - button "Околоцветник состоящий из лепестков — двойной." [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: Околоцветник состоящий из лепестков — двойной.
                - button "Все лепестки растения называются венчик." [ref=e177] [cursor=pointer]:
                  - generic [ref=e179] [cursor=pointer]: Все лепестки растения называются венчик.
