      ...
      - generic [ref=e90]:
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - generic [ref=e107]:
              - img "decore" [ref=e110]
              - generic [ref=e116]: Сопоставьте терминам их определения.
            - generic [ref=e119]:
              - img [ref=e120]
              - generic [ref=e121]:
                - generic [ref=e127] [cursor=pointer]: Это скорость, с которой распространяется гребень волны.
                - generic [ref=e134] [cursor=pointer]: Частота волны
              - generic [ref=e135]:
                - generic [ref=e141] [cursor=pointer]: Это расстояние между соседними максимумами волны.
                - generic [ref=e148] [cursor=pointer]: Длина волны
              - generic [ref=e149]:
                - generic [ref=e155] [cursor=pointer]: Это частота колебаний точек среды.
                - generic [ref=e162] [cursor=pointer]: Амплитуда волны
              - generic [ref=e163]:
                - generic [ref=e169] [cursor=pointer]: Это модуль наибольшего смещения частиц среды от положения равновесия.
                - generic [ref=e176] [cursor=pointer]: Скорость волны
