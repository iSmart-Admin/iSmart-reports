        ...
        - generic [ref=e99]:
          - region "Задача для решения" [ref=e101] [cursor=pointer]:
            - generic [ref=e103] [cursor=pointer]:
              ...
              - heading "Ошибка загрузки задания" [level=1] [ref=e124] [cursor=pointer]
              - paragraph [ref=e125] [cursor=pointer]: Приносим извинения за неудобства.
  ...
  - generic [ref=e139]:
    - generic [ref=e141]:
      - generic [ref=e142]:
        - generic [ref=e145]:
          - text: "Курс:"
          - generic [ref=e146]: Единицы времени (часть 2)
        - button [ref=e147] [cursor=pointer]:
          - img [ref=e149] [cursor=pointer]
      - heading "Широкие возможности урока от iSmart" [level=1] [ref=e157]
    - generic [ref=e160]:
      - button "<- Назад" [disabled] [ref=e161]
      - button "Подробнее о курсе ->" [ref=e162] [cursor=pointer]
```