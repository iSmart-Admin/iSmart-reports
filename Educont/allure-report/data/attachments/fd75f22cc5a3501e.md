      ...
      - generic [ref=e94]:
        - region "Задача для решения" [ref=e96] [cursor=pointer]:
          - generic [ref=e99]:
            - generic [ref=e101]:
              - img [ref=e105]
              - heading "Выбери вариант, в котором оба слова являются частью речи, которая служит для связи однородных членов, частей сложного предложения, а также предложений в тексте." [level=4] [ref=e107]:
                - generic [ref=e109]: Выбери вариант, в котором оба слова являются частью речи, которая служит для связи однородных членов, частей сложного предложения, а также предложений в тексте.
            - img "decore" [ref=e114]
            - generic [ref=e118]:
              - generic [ref=e121] [cursor=pointer]: лишь, только
              - generic [ref=e124] [cursor=pointer]: очень, часто
              - generic [ref=e127] [cursor=pointer]: или, зато
