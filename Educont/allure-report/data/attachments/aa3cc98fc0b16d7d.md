      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            - generic [ref=e106]:
              - img [ref=e110]
              - heading "В каком из предложенных примеров записано предложение?" [level=4] [ref=e112]:
                - generic [ref=e114]: В каком из предложенных примеров записано предложение?
            - img "decore" [ref=e119]
            - generic [ref=e122]:
              - button "Мама подарила дочке красивую брошь." [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Мама подарила дочке красивую брошь.
              - button "Дарить, мама, брошь, красивый, дочка." [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Дарить, мама, брошь, красивый, дочка.
              - button "Крутить, дача." [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: Крутить, дача.
