      ...
      - generic [ref=e90]:
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            - generic [ref=e97]:
              - img [ref=e101]
              - heading "Выберите все верные варианты ответа." [level=4] [ref=e103]:
                - generic [ref=e105]: Выберите все верные варианты ответа.
            - generic [ref=e107]:
              - img "decore" [ref=e110]
              - generic [ref=e116]: Выберите верные варианты об индивидуальных предпринимателях как субъектах малого и среднего бизнеса.
            - generic [ref=e121]:
              - generic [ref=e123] [cursor=pointer]: К плюсам индивидуального предпринимательства можно отнести самостоятельность в принятии решений.
              - generic [ref=e125] [cursor=pointer]: Индивидуальный предприниматель не может пользоваться упрощённой системой ведения бухгалтерии.
              - generic [ref=e127] [cursor=pointer]: К плюсам индивидуального предпринимательства можно отнести отсутствие возможности продать или переоформить бизнес.
              - generic [ref=e129] [cursor=pointer]: Государство заинтересовано в наличии большого количества производителей в различных отраслях.
              - generic [ref=e131] [cursor=pointer]: Индивидуальный предприниматель может использовать в производстве наёмный труд, регистрировать товарный знак, осуществлять свою деятельность под фирменным наименованием.
              - generic [ref=e133] [cursor=pointer]: Права индивидуального предпринимателя значительно ограничены.
