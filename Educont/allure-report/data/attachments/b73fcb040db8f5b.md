      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            - generic [ref=e94]:
              - img [ref=e98]
              - heading "Выбери верный вариант ответа в выпадающем списке." [level=4] [ref=e100]:
                - generic [ref=e102]: Выбери верный вариант ответа в выпадающем списке.
            - img "decore" [ref=e107]
            - generic [ref=e112]:
              - text: Явление резкого возрастания тока и тепловыделения в электрической цепи, называется
              - button [ref=e114] [cursor=pointer]
              - text: .
        - button "2 Взять 1 подсказку" [ref=e124] [cursor=pointer]:
          - generic [ref=e127] [cursor=pointer]: "2"
          - generic [ref=e128] [cursor=pointer]: Взять 1 подсказку
        - button "Далее" [ref=e130] [cursor=pointer]:
          - text: Далее
