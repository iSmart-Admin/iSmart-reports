      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: От чего зависит результат действия силы на тело?
            - generic [ref=e116]:
              - generic [ref=e120] [cursor=pointer]: от точки её приложения
              - generic [ref=e124] [cursor=pointer]: от её направления
              - generic [ref=e128] [cursor=pointer]: от её числового значения (модуля)
              - generic [ref=e132] [cursor=pointer]: от всех характеристик силы (направления, модуля, точки приложения)
