        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Роль биологии в познании мира. Биологические термины и источники знаний" [ref=e32] [cursor=pointer]':
      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Что такое антибиотики?
            - generic [ref=e128]:
              - button "Группа препаратов, предназначенных для борьбы с вирусами." [ref=e130] [cursor=pointer]:
                - generic [ref=e132] [cursor=pointer]: Группа препаратов, предназначенных для борьбы с вирусами.
              - button "Препараты для вакцинации." [ref=e134] [cursor=pointer]:
                - generic [ref=e136] [cursor=pointer]: Препараты для вакцинации.
              - button "Группа препаратов, предназначенных для борьбы с бактериями." [ref=e138] [cursor=pointer]:
                - generic [ref=e140] [cursor=pointer]: Группа препаратов, предназначенных для борьбы с бактериями.
              - button "Препараты от температуры." [ref=e142] [cursor=pointer]:
                - generic [ref=e144] [cursor=pointer]: Препараты от температуры.
