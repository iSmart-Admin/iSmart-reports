      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Установите соответствие между экспериментами и физическими явлениями, которые в них наблюдаются.
            - generic [ref=e116]:
              - img [ref=e117]
              - generic [ref=e118]:
                - generic [ref=e124] [cursor=pointer]: Давление света
                - generic [ref=e131] [cursor=pointer]: Если поместить внутрь колбы, из которой откачан воздух, легкую крыльчатку и направить на нее яркий свет, то крыльчатка будет вращаться.
              - generic [ref=e132]:
                - generic [ref=e138] [cursor=pointer]: Интерференция света
                - generic [ref=e145] [cursor=pointer]: "Ограничение оптических приборов: невозможно рассмотреть детали меньшие длины волны света."
              - generic [ref=e146]:
                - generic [ref=e152] [cursor=pointer]: Фотоэффект
                - generic [ref=e159] [cursor=pointer]: При освещении металлической пластины из неё вылетают электроны — это можно зарегистрировать, включив её как анод в электрическую цепь.
              - generic [ref=e160]:
                - generic [ref=e166] [cursor=pointer]: Дифракция света
                - generic [ref=e173] [cursor=pointer]: Радужные круги на воде с поверхностной бензиновой плёнкой.
