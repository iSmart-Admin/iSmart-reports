      ...
      - generic [ref=e99]:
        - region "Задача для решения" [ref=e101] [cursor=pointer]:
          - generic [ref=e104]:
            ...
            - generic [ref=e116]:
              - img "decore" [ref=e119]
              - generic [ref=e125]: Что из перечисленного не является преступлением?
            - generic [ref=e128]:
              - button "Кража" [ref=e130] [cursor=pointer]:
                - generic [ref=e132] [cursor=pointer]: Кража
              - button "Убийство" [ref=e134] [cursor=pointer]:
                - generic [ref=e136] [cursor=pointer]: Убийство
              - button "Оскорбление" [ref=e138] [cursor=pointer]:
                - generic [ref=e140] [cursor=pointer]: Оскорбление
              - button "Причинение вреда здоровью" [ref=e142] [cursor=pointer]:
                - generic [ref=e144] [cursor=pointer]: Причинение вреда здоровью
              - button "Клевета" [ref=e146] [cursor=pointer]:
                - generic [ref=e148] [cursor=pointer]: Клевета
