      ...
      - generic [ref=e93]:
        - region "Задача для решения" [ref=e95] [cursor=pointer]:
          - generic [ref=e98]:
            - generic [ref=e100]:
              - img [ref=e104]
              - heading "Перенеси элементы в соответствующие ячейки." [level=4] [ref=e106]:
                - generic [ref=e108]: Перенеси элементы в соответствующие ячейки.
            - generic [ref=e110]:
              - img "decore" [ref=e113]
              - generic [ref=e119]: Распредели количественные и качественные характеристики.
            - generic [ref=e121]:
              - generic [ref=e122]:
                - generic [ref=e126]: Количественные
                - generic [ref=e133]: Качественные
              - generic [ref=e137]:
                - button "ареал обитания" [ref=e141] [cursor=pointer]:
                  - generic [ref=e143] [cursor=pointer]: ареал обитания
                - button "высота" [ref=e147] [cursor=pointer]:
                  - generic [ref=e149] [cursor=pointer]: высота
                - button "масса" [ref=e153] [cursor=pointer]:
                  - generic [ref=e155] [cursor=pointer]: масса
                - button "маршруты миграции" [ref=e159] [cursor=pointer]:
                  - generic [ref=e161] [cursor=pointer]: маршруты миграции
                - button "окраска" [ref=e165] [cursor=pointer]:
                  - generic [ref=e167] [cursor=pointer]: окраска
                - button "скорость бега" [ref=e171] [cursor=pointer]:
                  - generic [ref=e173] [cursor=pointer]: скорость бега
                - button "длина" [ref=e177] [cursor=pointer]:
                  - generic [ref=e179] [cursor=pointer]: длина
                - button "ширина" [ref=e183] [cursor=pointer]:
                  - generic [ref=e185] [cursor=pointer]: ширина
                - button "жилкование листа" [ref=e189] [cursor=pointer]:
                  - generic [ref=e191] [cursor=pointer]: жилкование листа
