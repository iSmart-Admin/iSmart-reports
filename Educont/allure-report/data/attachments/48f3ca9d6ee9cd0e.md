      ...
      - generic [ref=e90]:
        - region "Задача для решения" [ref=e92] [cursor=pointer]:
          - generic [ref=e95]:
            ...
            - generic [ref=e107]:
              - img "decore" [ref=e110]
              - generic [ref=e116]: Укажи принципы, которые относятся к построению дерева случайного опыта.
            - generic [ref=e119]:
              - button "из каждой вершины должно выходить только ребра" [ref=e121] [cursor=pointer]:
                - generic [ref=e123] [cursor=pointer]:
                  ...
                  - text: ребра
              - button "к каждой конечной вершине ведёт единственный путь от корня" [ref=e135] [cursor=pointer]:
                - generic [ref=e137] [cursor=pointer]: к каждой конечной вершине ведёт единственный путь от корня
              - button "сумма вероятностей около всех рёбер равна" [ref=e139] [cursor=pointer]:
              ...
              - button "элементарным событиям соответствуют конечные вершины дерева" [ref=e153] [cursor=pointer]:
                - generic [ref=e155] [cursor=pointer]: элементарным событиям соответствуют конечные вершины дерева
