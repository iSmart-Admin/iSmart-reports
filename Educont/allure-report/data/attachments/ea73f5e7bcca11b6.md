      ...
      - generic [ref=e27]:
        - generic [ref=e28]:
          - generic [ref=e29]:
            - generic [ref=e30]:
              ...
              - 'img "Название урока: Вычисление неизвестного компонента действий сложения и вычитания" [ref=e32] [cursor=pointer]':
          ...
          - generic [ref=e84]:
            ...
            - button "Настроить класс для аналитики" [ref=e93] [cursor=pointer]:
              - generic [ref=e94] [cursor=pointer]: Настроить класс для аналитики
          - generic [ref=e95]:
        ...
        - generic [ref=e118] [cursor=pointer]:
          - generic [ref=e119] [cursor=pointer]:
            ...
            - generic [ref=e121] [cursor=pointer]: Тест educont 2
      ...
      - generic [ref=e128]:
        - region "Задача для решения" [ref=e130] [cursor=pointer]:
          - generic [ref=e133]:
            - generic [ref=e135]:
              - img [ref=e139]
              - heading "Выбери уравнения, которые решаются делением." [level=4] [ref=e141]:
                - generic [ref=e143]:
                  - text: Выбери уравнения, которые решаются
                  - strong [ref=e144]: делением
                  - text: .
            - img "decore" [ref=e149]
            - generic [ref=e152]:
              - 'button "1 953 : а = 63" [ref=e154] [cursor=pointer]':
                - generic [ref=e156] [cursor=pointer]: "1 953 : а = 63"
              - 'button "а : 4 = 7 496" [ref=e158] [cursor=pointer]':
                - generic [ref=e160] [cursor=pointer]: "а : 4 = 7 496"
              - button "3 274 • а = 22 918" [ref=e162] [cursor=pointer]:
                - generic [ref=e164] [cursor=pointer]: 3 274 • а = 22 918
              - 'button "а : 756 = 12" [ref=e166] [cursor=pointer]':
                - generic [ref=e168] [cursor=pointer]: "а : 756 = 12"
        ...
        - button "Подтвердить и продолжить" [ref=e183] [cursor=pointer]:
