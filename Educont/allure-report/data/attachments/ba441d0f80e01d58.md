        ...
        - region "Задача для решения" [ref=e98] [cursor=pointer]:
          - generic [ref=e101]:
            ...
            - generic [ref=e118]:
              - generic [ref=e119]:
                - generic [ref=e120]:
                  - generic [ref=e126]: Капитализм
                  - button [disabled] [ref=e132]
                - generic [ref=e133]:
                  - generic [ref=e139]: Капитал
                  - button [disabled] [ref=e145]
                - generic [ref=e146]:
                  - generic [ref=e152]: Прибыль
                  - button [disabled] [ref=e158]
              - generic [ref=e159]:
                - button "Разница между расходами на производство и прибылью, которую продавец получает после продажи товара." [ref=e163] [cursor=pointer]:
                  - generic [ref=e164] [cursor=pointer]: Разница между расходами на производство и прибылью, которую продавец получает после продажи товара.
                - button "Средства, которые люди вкладывают в производство, с целью получения прибыли." [ref=e168] [cursor=pointer]:
                  - generic [ref=e169] [cursor=pointer]: Средства, которые люди вкладывают в производство, с целью получения прибыли.
                - button "Общественный строй, основанный на частной собственности, наёмном труде и расширенном производстве." [ref=e173] [cursor=pointer]:
                  - generic [ref=e174] [cursor=pointer]: Общественный строй, основанный на частной собственности, наёмном труде и расширенном производстве.
        - button "1 Взять 1 подсказку" [ref=e183] [cursor=pointer]:
