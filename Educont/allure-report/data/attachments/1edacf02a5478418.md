      ...
      - generic [ref=e87]:
        - region "Задача для решения" [ref=e89] [cursor=pointer]:
          - generic [ref=e92]:
            ...
            - generic [ref=e104]:
              - img "decore" [ref=e107]
              - generic [ref=e113]: Соедини положения МКТ и опыты, которые их подтверждают.
            - generic [ref=e116]:
              - img [ref=e117]
              - generic [ref=e118]:
                - generic [ref=e124] [cursor=pointer]: Броуновское движение
                - generic [ref=e131] [cursor=pointer]: Все тела состоят из частиц (атомов и молекул).
              - generic [ref=e132]:
                - generic [ref=e138] [cursor=pointer]: Изображение атома, полученное автоионным микроскопом
                - generic [ref=e145] [cursor=pointer]: Частицы находятся в беспорядочном, хаотическом движении.
              - generic [ref=e146]:
                - generic [ref=e152] [cursor=pointer]: Явление смачивания жидкостью
                - generic [ref=e159] [cursor=pointer]: Частицы взаимодействуют друг с другом. Притягиваются и отталкиваются.
