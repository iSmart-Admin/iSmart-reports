      ...
      - generic [ref=e89]:
        - region "Задача для решения" [ref=e91] [cursor=pointer]:
          - generic [ref=e94]:
            ...
            - generic [ref=e106]:
              - img "decore" [ref=e109]
              - generic [ref=e115]: Что такое антибиотики?
            - generic [ref=e118]:
              - button "Группа препаратов, предназначенных для борьбы с вирусами." [ref=e120] [cursor=pointer]:
                - generic [ref=e122] [cursor=pointer]: Группа препаратов, предназначенных для борьбы с вирусами.
              - button "Препараты для вакцинации." [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Препараты для вакцинации.
              - button "Группа препаратов, предназначенных для борьбы с бактериями." [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Группа препаратов, предназначенных для борьбы с бактериями.
              - button "Препараты от температуры." [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: Препараты от температуры.
