...
- generic [ref=e5]:
  ...
  - generic:
    - generic:
      ...
      - generic [ref=e1587]:
        - generic [ref=e1588]:
          - region "Задача для решения" [active] [ref=e1590] [cursor=pointer]:
            - generic [ref=e1591] [cursor=pointer]:
              ...
              - generic [ref=e1600]:
                - generic [ref=e1602]:
                  ...
                  - heading "красный." [level=4] [ref=e1607]:
                    - generic [ref=e1609]:
                      - img [ref=e1611]
                      - text: красный.
                - img "decore" [ref=e1616]
                - table [ref=e1626] [cursor=pointer]:
                  - rowgroup [ref=e1627] [cursor=pointer]:
                    - row [ref=e1628] [cursor=pointer]:
                      - cell [ref=e1629] [cursor=pointer]:
        ...
        - generic [ref=e1657]:
          - generic [ref=e1660]: Интеллектуальный тренажер
          - generic [ref=e1664]:
            - generic [ref=e1669]: 1 из 8
            - button "Ввести код от учителя" [ref=e1673] [cursor=pointer]: Ввести код от учителя
          - generic [ref=e1676]:
            - generic [ref=e1678]:
              - button "Черновик" [ref=e1679] [cursor=pointer]:
                - img [ref=e1682] [cursor=pointer]
                - text: Черновик
              - button "Сообщить об ошибке" [ref=e1685] [cursor=pointer]:
                - img [ref=e1688] [cursor=pointer]
                - text: Сообщить об ошибке
            - generic [ref=e1690]:
              - generic [ref=e1691]:
                - img [ref=e1693]
                - generic [ref=e1695]: Реши задание, прежде чем подтвердить
              - button "Подтвердить" [ref=e1696] [cursor=pointer]:
                - text: Подтвердить
                - img [ref=e1699] [cursor=pointer]
              - generic [ref=e1702]: 69a3135b02390a0007f89db9
```