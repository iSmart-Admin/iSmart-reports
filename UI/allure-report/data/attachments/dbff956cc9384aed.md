      ...
      - generic [ref=e84]:
        - region "Задача для решения" [ref=e86] [cursor=pointer]:
          - generic [ref=e89]:
            - generic [ref=e91]:
              - img [ref=e95]
              - heading "Распредели глаголы в три столбика." [level=4] [ref=e97]:
                - generic [ref=e99]: Распредели глаголы в три столбика.
            - img "decore" [ref=e104]
            - generic [ref=e106]:
              - generic [ref=e107]:
                - generic [ref=e111]: Глаголы в начальной форме
                - generic [ref=e118]: Глаголы 2 лица единственного числа
                - generic [ref=e125]: Глаголы, выражающие приказ или просьбу
              - generic [ref=e129]:
                - button "обрежь" [ref=e133] [cursor=pointer]:
                  - generic [ref=e135] [cursor=pointer]: обрежь
                - button "рисуешь" [ref=e139] [cursor=pointer]:
                  - generic [ref=e141] [cursor=pointer]: рисуешь
                - button "извлечь" [ref=e145] [cursor=pointer]:
                  - generic [ref=e147] [cursor=pointer]: извлечь
                - button "толочь" [ref=e151] [cursor=pointer]:
                  - generic [ref=e153] [cursor=pointer]: толочь
                - button "поставишь" [ref=e157] [cursor=pointer]:
                  - generic [ref=e159] [cursor=pointer]: поставишь
                - button "перепрячь" [ref=e163] [cursor=pointer]:
                  - generic [ref=e165] [cursor=pointer]: перепрячь
