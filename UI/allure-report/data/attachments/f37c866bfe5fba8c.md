      ...
      - generic [ref=e89]:
        - region "Задача для решения" [ref=e91] [cursor=pointer]:
          - generic [ref=e94]:
            ...
            - generic [ref=e106]:
              - img "decore" [ref=e109]
              - generic [ref=e115]: Укажи верные утверждения о причинах отсталости сельского хозяйства Франции при Cтаром порядке.
            - generic [ref=e118]:
              - button "Крестьянское малоземелье" [ref=e120] [cursor=pointer]:
                - generic [ref=e122] [cursor=pointer]: Крестьянское малоземелье
              - button "Чересполосица" [ref=e124] [cursor=pointer]:
                - generic [ref=e126] [cursor=pointer]: Чересполосица
              - button "Неразвитость передовых технологий обработки земли" [ref=e128] [cursor=pointer]:
                - generic [ref=e130] [cursor=pointer]: Неразвитость передовых технологий обработки земли
              - button "Быстрый рост капиталистических отношений" [ref=e132] [cursor=pointer]:
                - generic [ref=e134] [cursor=pointer]: Быстрый рост капиталистических отношений
