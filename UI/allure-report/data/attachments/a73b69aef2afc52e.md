        ...
        - region "Задача для решения" [ref=e26] [cursor=pointer]:
          - generic [ref=e27] [cursor=pointer]:
            ...
            - generic [ref=e57]:
              ...
              - generic [ref=e69]:
                - img "decore" [ref=e72]
                - generic [ref=e78]: "В какой момент рыбак повторял одну и ту же фразу: «Господи, как хорошо!»?"
              - generic [ref=e81]:
                - button "Когда был хороший улов" [ref=e83] [cursor=pointer]:
                  - generic [ref=e85] [cursor=pointer]: Когда был хороший улов
                - button "Когда приходил после трудового дня домой" [ref=e87] [cursor=pointer]:
                  - generic [ref=e89] [cursor=pointer]: Когда приходил после трудового дня домой
                - button "Когда слышал пение соловья" [ref=e91] [cursor=pointer]:
                  - generic [ref=e93] [cursor=pointer]: Когда слышал пение соловья
        - generic [ref=e98]:
          - generic [ref=e101]:
